<%
    ...
    String datos=(String) sesion1.getAttribute("datos");
    String idUser=(String) sesion1.getAttribute("idUser");
    if(idUser !=null)
    {
%>
<!DOCTYPE html>
<html lang="es">
  <head>
    ...
    <title>Iglesia Villa Union</title>
      ...
      <div class="container">
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
                ...
                <a class="navbar-brand" href="#">Iglesia Villa Union</a>
            </div>
         ...
         <ul class="nav navbar-nav navbar-right">
             <li><a><%=datos%><span class="sr-only">(current)</span></a></li>
         </ul>
            </div>
          </div>
        </nav>
